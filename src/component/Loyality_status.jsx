...
import loyal from '../assets/image/loyali.svg';
        ...
        < >
            <div className='d-lg-flex hm-top-pnl' >
                        ...
                        <div className="d-flex justify-content-between pt-3">
                            <div className="side-line ">
                                ...
                                <div className="d-flex mx-0 px-0">
                                    <div className="text-white fs-3">$0 <Badge className="bg-dark4 fs-6 text-light2 fw-normal  ms-1 mb-1 badge1" >Standard</Badge></div>
                                </div>
                            </div>
                            <div className="side-line left-space">
                                ...
                                <div className="text-white fs-3 ms-2" >$75.00</div>
                            </div>
                        </div>
                        <div className="progress mt-2 rounded-bottom" style={{ height: "45px" }}>
                            <div className="progress-bar bg-orange" role="progressbar" style={{ width: "2%" }}
                                aria-valuenow="75" aria-valuemin="0"
                                aria-valuemax="100">
                            </div>
                        </div>
                        <Image src={loyal} width={'100%'} className='mt-5' />
                    </Card.Body>
                </Card>
                {/* <Loyality_status /> */}
                ...
                <Card className='bg-dark2 help-center'>
                    <Card.Body>
                        <h3 className="mb-4 text-light fs-5">Help Center</h3>
            ...
            <Card className='bg-dark2 btm-table '>
                <Card.Body className='px-2 table-responsive'>
                    <Table bordered className='border-dark my-0' >
                        <thead>
                            <tr className='no-border'>
                                ...
                                <th className='text-end'><span className="action1" >Actions</span></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr className='no-border'>
                                <td>
                                    <div className="d-flex align-items-center">
                                        <GoCopy className='me-2 fs-6 cursor' />
                                        <span>#AP1934</span>
                                    </div>
                                </td>
                                <td className='fs-5'>Static Proxies</td>
                                <td className='fs-5'>26 April 2016</td>
                                <td className='fs-5'>4GB</td>
                                <td>
                                    <div className='rounded-2 px-2 py-1 status-wait2 fs-5'><GoDotFill className='me-1' />Waiting</div>
                                </td>
                                <td className='fs-5'>$33.00</td>
                                <td className='text-end'><Button className="rounded-3 help_center fs-4" onClick={showdownload} >Download Invoice</Button></td>
                            </tr>
                            <tr >
                                <td>
                                    <div className="d-flex align-items-center">
                            ...
                            <tr >
                                ...
                                <td className='fs-5'>Residential Proxies</td>
                                <td className='fs-5'>26 April 2016</td>
                                <td className='fs-5'>4GB</td>
                                <td>
                                    <div className='rounded-2 px-2 py-1 status-active2 fs-5'><GoDotFill className='me-1' />Active</div>
                                </td>
                                <td className='fs-5'>$33.00</td>
                                <td className='text-end'><Button className="rounded-3 help_center fs-4" onClick={showdownload} >Download Invoice</Button></td>
                            </tr>
                            <tr >
                                ...
                                <td className='fs-5'>4GB</td>
                                <td>
                                    <div className='rounded-2 px-2 py-1 status-expire2 fs-5'><GoDotFill className='me-1' />Expired</div>
                                </td>
                                <td className='fs-5'>$33.00</td>
                                <td className='text-end'><Button className="rounded-3 help_center fs-4" onClick={showdownload} >Download Invoice</Button></td>
                            </tr>
                            <tr >
                                ...
                                <td className='fs-5'>hybrid Proxies</td>
                                <td className='fs-5'>26 April 2016</td>
                                <td className='fs-5'>4GB</td>
                                <td>
                                    <div className='rounded-2 px-2 py-1 status-expire2 fs-5'><GoDotFill className='me-1' />Expired</div>
            ...
            <Modal show={insert} onHide={handleClose} centered className='custom-modal ' >
                ...
                <Modal.Body className='m-0 p-0 promo px-0 rounded-modal bg-modal border border-2 border-dark'  >
                    <div className="d-flex justify-content-between ">
                        <h6 className='text-white my-2 ms-3 py-2 fs-5'>Insert VAT</h6>
                        ...
                        <Row className='g-1'>
                            <Col md={12}>
                                <div class="form-group mb-1 mt-2">
                                    ...
                                    <input type="text" name="" className="form-control py-2 text-light border-0 fs-5 bg-modal-input" id="basic-default-category" value='Near NineTeen' />
                                </div>
                            </Col>
                            <Col md={12}>
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="" className="form-control py-2 text-light border-0 fs-5 bg-modal-input" id="basic-default-category" value='1234567891234891234' />
                                </div>
                            </Col>
                            <Col md={12}>
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="" className="form-control py-2 text-light border-0 fs-5 bg-modal-input" id="basic-default-category" value='Avenida da Liberdade n19' />
                                </div>
                            </Col>
                            <Col md={6}>
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="" className="form-control py-2 text-light border-0 fs-5 bg-modal-input" id="basic-default-category" value='4422-322' />
                                </div>
                            </Col>
                            <Col md={6}>
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="" className="form-control py-2 text-light border-0 fs-5 bg-modal-input" id="basic-default-category" value='Lisboa' />
                                </div>
                            </Col>

                            <Col md={6}>
                                <Button className='w-100 mt-4  py-1 f-1 cmn-btn-format btn-border' onClick={hideinsert}>Cancel</Button>
                            </Col>
                            <Col md={6}>
            ...
            <Modal show={offer} onHide={handleClose6} centered className='custom-modal' >
                <Modal.Body className='m-0 p-0 border border-2 border-dark px-0 rounded-2 bg-modal' closeButton  >
                    <Container fluid className='mt-3 text-center mb-4'>
                    ...
                    <Container fluid className=' mt-2 mb-4 px-2'>
                        <InputGroup className="mb-3">
                            ...
                            />
                            <InputGroup.Text className='text-white bg-orange border-0 btn' onClick={copyToClipboard3}>{buttonText3}</InputGroup.Text>
                        </InputGroup>
                    </Container>
                </Modal.Body>
            </Modal>
